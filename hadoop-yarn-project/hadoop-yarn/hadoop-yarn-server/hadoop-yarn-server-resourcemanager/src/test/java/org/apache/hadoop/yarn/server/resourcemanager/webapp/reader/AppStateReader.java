...
/**
 * We have defined a dedicated Reader for AppState,
 * aimed at adapting to the Jersey2 framework
 * to ensure that JSON can be converted into AppState.
 */
@Provider
@Consumes(MediaType.APPLICATION_JSON)
public class AppStateReader implements MessageBodyReader<AppState> {
  ...
  @Override
  public AppState readFrom(Class<AppState> type, Type genericType, Annotation[] annotations,
